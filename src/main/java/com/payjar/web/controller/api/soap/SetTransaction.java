 ...
 *         &lt;element name="EWalletPagaTech" type="{http://soap.api.controller.web.payjar.com/}eWalletPagaTech" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "setTransaction")
public class SetTransaction {
    ...
    @XmlElement(name = "EWalletPagaTech")
    protected List<EWalletPagaTech> eWalletPagaTech;
    ...
    /**
     * Gets the value of the eWalletPagaTech property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the eWalletPagaTech property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEWalletPagaTech().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EWalletPagaTech }
     * 
     * 
     */
    public List<EWalletPagaTech> getEWalletPagaTech() {
        if (eWalletPagaTech == null) {
            eWalletPagaTech = new ArrayList<EWalletPagaTech>();
        }
        return this.eWalletPagaTech;
    }
